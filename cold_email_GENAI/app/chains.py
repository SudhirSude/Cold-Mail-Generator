...
class Chain:
    ...
    def write_mail(self, job, links):
        ...
        ### INSTRUCTION:
        You are Sudhir Sude, a pass out B.Tech CSE student from the Indian Institute of Information Technology, Pune (IIIT Pune). You are looking for job/internship opportunities. Your job is to write     a cold email to the client regarding the job mentioned above, 
